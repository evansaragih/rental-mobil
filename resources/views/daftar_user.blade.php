...
<html lang="en">
    <head>
        ...
        <title>RentCar</title>
        <!-- Bootstrap Core CSS -->
        <link href="../../public/css/backend_css/lib/bootstrap/bootstrap.min.css" rel="stylesheet">
        <!-- Custom CSS -->
        <link href="../../public/css/backend_css/helper.css" rel="stylesheet">
        <link href="../../public/css/backend_css/style.css" rel="stylesheet">
    ...
    <div id="main-wrapper">
        ...
        <div class="header2">
            <span class="bar_atas">
                <a href="#" class="jarak">JOIN RENTCAR</a>
                <a href="#" class="jarak">PESANAN</a>
                <a href="#" class="jarak">LOGIN </a>
                <a href="#" class="jarak">DAFTAR</a>
            </span>
        </div>
        <div class="header">
                    ...
                    <ul class="navbar-nav my-lg-0">
                                        ...
                                        <div class="message-center">
                                            ...
                                            <a href="#">
                                                ...
                                                <div class="mail-contnet">
                                                    <h5>This is title</h5> 
                                                    <span class="mail-desc">Just see the my new admin!
                                                    </span> 
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <div class="message-center">
                                            ...
                                            <a href="#">
                                                <div class="user-img"> 
                                                    <img src="../../public/images/users/5.jpg" alt="user" class="img-circle"> 
                                            ...
                                            <a href="#">
                                                <div class="user-img"> 
                                                    <img src="../../public/images/users/2.jpg" alt="user" class="img-circle"> 
                                            ...
                                            <a href="#">
                                                <div class="user-img"> 
                                                    <img src="../../public/images/users/3.jpg" alt="user" class="img-circle"> 
                                            ...
                                            <a href="#">
                                                <div class="user-img"> 
                                                    <img src="../../public/images/users/4.jpg" alt="user" class="img-circle"> 
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img src="../../public/images/users/5.jpg" alt="user" class="profile-pic" />
                            </a>
                    ...
                    <div class="card-body"> 
                        <h2><b>Buat Akun RentCar Anda</b></h2>
                            <span>sudah menjadi member?
                                <a href="halaman_login1.html"> Login </a>disini</span>
                    </div>
                </div>
            </div>
            <!-- page content -->
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <div>
                                                    ...
                                                    <input type="date" id="val-" class="form-control" placeholder="tanggal lahir">
                                                </div>
                                            </div>
                                        </div>
                                        <!--/span-->
        ...
        <!-- End Container fluid  -->
        <!-- footer -->
        <footer class="footer"> © 2018 <a href="#">RentCar</a></footer>
        <!-- End footer -->
    ...
    <!-- End Wrapper -->
    <!-- All Jquery -->
    <script src="../../public/js/backend_js/lib/jquery/jquery.min.js"></script>
    <!-- Bootstrap tether Core JavaScript -->
    <script src="../../public/js/backend_js/lib/bootstrap/js/popper.min.js"></script>
    <script src="../../public/js/backend_js/lib/bootstrap/js/bootstrap.min.js"></script>
    <!-- slimscrollbar scrollbar JavaScript -->
    <script src="../../public/js/backend_js/jquery.slimscroll.js"></script>
    <!--Menu sidebar -->
    <script src="../../public/js/backend_js/sidebarmenu.js"></script>
    <!--stickey kit -->
    <script src="../../public/js/backend_js/lib/sticky-kit-master/dist/sticky-kit.min.js"></script>
    

    <!-- Form validation -->
    <script src="../../public/js/backend_js/lib/form-validation/jquery.validate.min.js"></script>
    <script src="../../public/js/backend_js/lib/form-validation/jquery.validate-init.js"></script>
    <!--Custom JavaScript -->
    <script src="../../public/js/backend_js/custom.min.js"></script>
    </body>
